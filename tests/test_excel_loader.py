from core.data.excel_loader import load_historical_financials_from_excel


def test_excel_financial_loader():

    file_path = "data/sample/historical_financials.xlsx"

    financials = load_historical_financials_from_excel(
        file_path
    )
